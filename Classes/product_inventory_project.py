...
def bill_print(lap,mob,ear,power,l,m,e,p):
    ...
    if lap > 0:
        print('|{0:^14}|{1:^16}|{2:^14}|{3:^16}|'.format(l.name,l.price,lap,l.price*lap))
        print('|              |                |              |                |')
    pass
    if mob > 0:
    ...
    print('|______________|________________|______________|________________|')
    print('|{0:^14}|{1:^16}|{2:^14}|{3:^16}|'.format('Total','--',(lap+mob+ear+power),(l.price*lap+m.price*mob+e.price*ear+p.price*power)))
    print('|______________|________________|______________|________________|')  
...
def main():
    ...
    while True:
        ...
        if user_input == 1:
            ...
            print('|{0:<14}|{1:^14}|{2:^14}|'.format(l.name,l.price,l.quantity))
            print('|              |              |              |')
            ...
            if lap == 0 and mob == 0 and ear == 0 and power == 0:
                ...
                bill_print(lap, mob, ear, power, l, m, e, p)
